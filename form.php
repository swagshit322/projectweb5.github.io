...
if (!empty($_COOKIE[session_name()])) {
    ...
    if (!empty($_SESSION['login'])) {
        echo '<div style="text-align: right; margin-bottom: 1rem;"><a href="logout.php" style="background:#c9772e; color:white; padding:0.5rem 1rem; border-radius:2rem; text-decoration:none;">🚪 Выйти ('.htmlspecialchars($_SESSION['login']).')</a></div>';
    }
}
?>
